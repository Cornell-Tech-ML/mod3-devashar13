...
def _tensor_matrix_multiply(
    ...
    """
    CUDA tensor matrix multiply function with corrected shared memory access.
    """
    ...
    for block in range((a_shape[-1] + BLOCK_DIM - 1) // BLOCK_DIM):
        ...
        a_row = i
        a_col = block * BLOCK_DIM + y
        b_row = block * BLOCK_DIM + x
        b_col = j
